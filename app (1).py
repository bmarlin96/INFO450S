...
penguin_counts.columns=["island","count"]
fig=px.bar(penguin_counts,x="island",y="count",color="island",color_discrete_sequence=px.colors.qualitative.Set1)
st.plotly_chart(fig)
...
box_metric=st.selectbox("Choose the measurement to display", ["body_mass_g","bill_length_mm", "flipper_length_mm"])
...
fig_scatter=px.scatter(df_filtered,x="body_mass_g",y="bill_length_mm", color="species", size="body_mass_g", color_discrete_map={"Adelie": "blue",
                                     "Chinstrap": "red",
...
fig_map=px.scatter_map(df_filtered,lat="latitude", lon="longitude",color="species", color_discrete_map={"Adelie": "blue",
                                     "Chinstrap": "red",
